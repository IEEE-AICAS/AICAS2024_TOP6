...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o: ../examples/train-text-from-scratch/train-text-from-scratch.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/AICAS/llama_cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o"
	cd /root/AICAS/llama_cpp/build/examples/train-text-from-scratch && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.o -c /root/AICAS/llama_cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.i: cmake_force
	...
	cd /root/AICAS/llama_cpp/build/examples/train-text-from-scratch && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/AICAS/llama_cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp > CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.i
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.s: cmake_force
	...
	cd /root/AICAS/llama_cpp/build/examples/train-text-from-scratch && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/AICAS/llama_cpp/examples/train-text-from-scratch/train-text-from-scratch.cpp -o CMakeFiles/train-text-from-scratch.dir/train-text-from-scratch.cpp.s
...
bin/train-text-from-scratch: examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/AICAS/llama_cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/train-text-from-scratch"
	cd /root/AICAS/llama_cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/train-text-from-scratch.dir/link.txt --verbose=$(VERBOSE)
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/clean:
	cd /root/AICAS/llama_cpp/build/examples/train-text-from-scratch && $(CMAKE_COMMAND) -P CMakeFiles/train-text-from-scratch.dir/cmake_clean.cmake
...
examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/depend:
	cd /root/AICAS/llama_cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/AICAS/llama_cpp /root/AICAS/llama_cpp/examples/train-text-from-scratch /root/AICAS/llama_cpp/build /root/AICAS/llama_cpp/build/examples/train-text-from-scratch /root/AICAS/llama_cpp/build/examples/train-text-from-scratch/CMakeFiles/train-text-from-scratch.dir/DependInfo.cmake --color=$(COLOR)
