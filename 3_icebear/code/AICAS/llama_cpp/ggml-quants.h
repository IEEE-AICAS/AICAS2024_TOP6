...
void quantize_row_q8_0_and_make_block_q8_0x2(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int k, int rows_interleaved);
void quantize_row_q8_0_and_make_block_q8_0x4(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int k, int rows_interleaved);
...
void ggml_gemm_q4_0_q8_0_2x4blocked_mmla(const int n, int output_channels, int input_width, float * GGML_RESTRICT s, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int ith, int nth);
...
void ggml_gemm_q8_0_q8_0_2x4blocked_mmla(const int n, int output_channels, int input_width, float * GGML_RESTRICT s, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int ith, int nth);
