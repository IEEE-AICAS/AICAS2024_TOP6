    ...
    llama_model_loader(const std::string & fname, bool use_mmap, const struct llama_model_kv_override * param_overrides_p) {
        ...
        // TODO: make optional
        {
            ...
            switch (type_max) {
                ...
                //HMK                
                case GGML_TYPE_Q4_0_F:    ftype = LLAMA_FTYPE_MOSTLY_Q4_0_F;    break;                
                case GGML_TYPE_Q4_0_H:    ftype = LLAMA_FTYPE_MOSTLY_Q4_0_H;    break;
                case GGML_TYPE_Q4_0_S:    ftype = LLAMA_FTYPE_MOSTLY_Q4_0_S;    break;
               ...
               //HMK
                case GGML_TYPE_Q8_0_H:  ftype = LLAMA_FTYPE_MOSTLY_Q8_0_H;  break;
                case GGML_TYPE_Q8_0_S:  ftype = LLAMA_FTYPE_MOSTLY_Q8_0_S;  break;
                case GGML_TYPE_Q8_0_F:  ftype = LLAMA_FTYPE_MOSTLY_Q8_0_F;  break;
                case GGML_TYPE_Q8_0_M:  ftype = LLAMA_FTYPE_MOSTLY_Q8_0_M;  break;
...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_Q4_0_F: return "Q4_0_F";
        case LLAMA_FTYPE_MOSTLY_Q4_0_H: return "Q4_0_H";
        case LLAMA_FTYPE_MOSTLY_Q4_0_S: return "Q4_0_S";
        ...
        case LLAMA_FTYPE_MOSTLY_Q8_0_H: return "Q8_0_H";
        case LLAMA_FTYPE_MOSTLY_Q8_0_S: return "Q8_0_S";
        case LLAMA_FTYPE_MOSTLY_Q8_0_F: return "Q8_0_F";
        case LLAMA_FTYPE_MOSTLY_Q8_0_M: return "Q8_0_M";
...
static ggml_type llama_tensor_get_type(quantize_state_internal & qs, ggml_type new_type, const ggml_tensor * tensor, llama_ftype ftype) {
    ...
    if (name == tn(LLM_TENSOR_OUTPUT, "weight") || (!qs.has_output && name == tn(LLM_TENSOR_TOKEN_EMBD, "weight"))) {
        if (qs.params->output_tensor_type < GGML_TYPE_COUNT) {
            ...
            //HMK
            else if (new_type == GGML_TYPE_Q8_0_S){}
            else if (new_type == GGML_TYPE_Q8_0_H){}
            else if (new_type == GGML_TYPE_Q8_0_F){}            
            else if (new_type == GGML_TYPE_Q4_0_F){}
            else if (new_type == GGML_TYPE_Q4_0_H){}
            else if (new_type == GGML_TYPE_Q4_0_S){}
...
static void llama_model_quantize_internal(const std::string & fname_inp, const std::string & fname_out, const llama_model_quantize_params * params) {
    ...
    switch (params->ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_Q4_0_F: default_type = GGML_TYPE_Q4_0_F; break;
        case LLAMA_FTYPE_MOSTLY_Q4_0_H: default_type = GGML_TYPE_Q4_0_H; break;
        case LLAMA_FTYPE_MOSTLY_Q4_0_S: default_type = GGML_TYPE_Q4_0_S; break;
        case LLAMA_FTYPE_MOSTLY_Q4_1: default_type = GGML_TYPE_Q4_1; break;
        case LLAMA_FTYPE_MOSTLY_Q5_0: default_type = GGML_TYPE_Q5_0; break;
        case LLAMA_FTYPE_MOSTLY_Q5_1: default_type = GGML_TYPE_Q5_1; break;
        case LLAMA_FTYPE_MOSTLY_Q8_0: default_type = GGML_TYPE_Q8_0; break;
        //HMK
        case LLAMA_FTYPE_MOSTLY_Q8_0_H: default_type = GGML_TYPE_Q8_0_H; break;
        case LLAMA_FTYPE_MOSTLY_Q8_0_S: default_type = GGML_TYPE_Q8_0_S; break;
        case LLAMA_FTYPE_MOSTLY_Q8_0_F: default_type = GGML_TYPE_Q8_0_F; break;
        case LLAMA_FTYPE_MOSTLY_Q8_0_M: default_type = GGML_TYPE_Q8_0_M; break;
...
void llama_save_throughput_results(struct llama_context * ctx) {
    const llama_timings timings = llama_get_timings(ctx);

    double prefill_throughput = 1e3 / timings.t_p_eval_ms * timings.n_p_eval;
    double decode_throughput = 1e3 / timings.t_eval_ms * timings.n_eval;

    nlohmann::json results;
    results["prefill_throughput"] = prefill_throughput;
    results["decode_throughput"] = decode_throughput;

    std::ofstream output_file("throughput_results.json");
    output_file << results.dump(4);
    output_file.close();

    LLAMA_LOG_INFO("\nPrefill and Decode thorughput saved in throughput_result.json file\n");
}
