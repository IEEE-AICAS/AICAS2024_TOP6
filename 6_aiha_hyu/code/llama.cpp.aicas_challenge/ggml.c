...
static const ggml_type_traits_t type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_0_F] = {
        .type_name                = "q4_0_f",
        .blck_size                = QK4_0_F,
        .type_size                = sizeof(block_q4_0_f),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_f,
        .from_float               = quantize_row_q4_0_f,
        .from_float_reference     = (ggml_from_float_t) quantize_row_q4_0_f_reference,
        .vec_dot                  = ggml_vec_dot_q4_0_f_q8_0_f,
        .vec_dot_type             = GGML_TYPE_Q8_0_F,
#if defined (__ARM_FEATURE_MATMUL_INT8)
        .nrows                    = 2,
#else
        .nrows                    = 1,
    ...
    [GGML_TYPE_Q4_0_H] = {
        .type_name                = "q4_0_h",
        .blck_size                = QK4_0_H,
        .type_size                = sizeof(block_q4_0_h),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_h,
        .from_float               = quantize_row_q4_0_h,
        .from_float_reference     = (ggml_from_float_t) quantize_row_q4_0_h_reference,
        .vec_dot                  = ggml_vec_dot_q4_0_h_q8_0_h,
        .vec_dot_type             = GGML_TYPE_Q8_0_H,
#if defined (__ARM_FEATURE_MATMUL_INT8)
        .nrows                    = 2,
#else
        .nrows                    = 1,
    ...
    [GGML_TYPE_Q4_0_S] = {
        .type_name                = "q4_0_s",
        .blck_size                = QK4_0_S,
        .type_size                = sizeof(block_q4_0_s),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q4_0_s,
        .from_float               = quantize_row_q4_0_s,
        .from_float_reference     = (ggml_from_float_t) quantize_row_q4_0_s_reference,
        .vec_dot                  = ggml_vec_dot_q4_0_s_q8_0_s,
        .vec_dot_type             = GGML_TYPE_Q8_0_S,
#if defined (__ARM_FEATURE_MATMUL_INT8)
        .nrows                    = 2,
#else
        .nrows                    = 1,
...
//    },
    ...
    .type_name                = "q8_0_m",
    .blck_size                = QK8_0_M,
    .type_size                = sizeof(block_q8_0_m),
    .is_quantized             = true,
    .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_m,
    .from_float               = quantize_row_q8_0_m,
    .from_float_reference     = (ggml_from_float_t) quantize_row_q8_0_m_reference,
    .vec_dot                  = ggml_vec_dot_q8_0_m_q8_0_m,
    .vec_dot_type             = GGML_TYPE_Q8_0_M,
#if defined (__ARM_FEATURE_MATMUL_INT8)
    .nrows                    = 2,
#else
    .nrows                    = 1,
    ...
    .type_name                = "q8_0_f",
    .blck_size                = QK8_0_F,
    .type_size                = sizeof(block_q8_0_f),
    .is_quantized             = true,
    .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_f,
    .from_float               = quantize_row_q8_0_f,
    .from_float_reference     = (ggml_from_float_t) quantize_row_q8_0_f_reference,
    .vec_dot                  = ggml_vec_dot_q8_0_f_q8_0_f,
    .vec_dot_type             = GGML_TYPE_Q8_0_F,
#if defined (__ARM_FEATURE_MATMUL_INT8)
    .nrows                    = 2,
#else
    ...
    [GGML_TYPE_Q8_0_H] = {
        .type_name                = "q8_0_h",
        .blck_size                = QK8_0_H,
        .type_size                = sizeof(block_q8_0_h),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_h,
        .from_float               = quantize_row_q8_0_h,
        .from_float_reference     = (ggml_from_float_t) quantize_row_q8_0_h_reference,
        .vec_dot                  = ggml_vec_dot_q8_0_h_q8_0_h,
        .vec_dot_type             = GGML_TYPE_Q8_0_H,
#if defined (__ARM_FEATURE_MATMUL_INT8)
        .nrows                    = 2,
#else
    ...
    .type_name                = "q8_0_s",
    .blck_size                = QK8_0_S,
    .type_size                = sizeof(block_q8_0_s),
    .is_quantized             = true,
    .to_float                 = (ggml_to_float_t) dequantize_row_q8_0_s,
    .from_float               = quantize_row_q8_0_s,
    .from_float_reference     = (ggml_from_float_t) quantize_row_q8_0_s_reference,
    .vec_dot                  = ggml_vec_dot_q8_0_s_q8_0_s,
    .vec_dot_type             = GGML_TYPE_Q8_0_S,
#if defined (__ARM_FEATURE_MATMUL_INT8)
    .nrows                    = 2,
#else
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q4_0_F:          wtype = GGML_TYPE_Q4_0_F;  break;        
        case GGML_FTYPE_MOSTLY_Q4_0_H:          wtype = GGML_TYPE_Q4_0_H;  break;
        case GGML_FTYPE_MOSTLY_Q4_0_S:          wtype = GGML_TYPE_Q4_0_S;  break;
        case GGML_FTYPE_MOSTLY_Q4_1:          wtype = GGML_TYPE_Q4_1;  break;
        case GGML_FTYPE_MOSTLY_Q5_0:          wtype = GGML_TYPE_Q5_0;  break;
        case GGML_FTYPE_MOSTLY_Q5_1:          wtype = GGML_TYPE_Q5_1;  break;
        case GGML_FTYPE_MOSTLY_Q8_0:          wtype = GGML_TYPE_Q8_0;  break;
        case GGML_FTYPE_MOSTLY_Q8_0_H:        wtype = GGML_TYPE_Q8_0_H;  break;
        case GGML_FTYPE_MOSTLY_Q8_0_S:        wtype = GGML_TYPE_Q8_0_S;  break;
        case GGML_FTYPE_MOSTLY_Q8_0_F:        wtype = GGML_TYPE_Q8_0_F;  break;
        case GGML_FTYPE_MOSTLY_Q8_0_M:        wtype = GGML_TYPE_Q8_0_M;  break;
...
static void ggml_compute_forward_mul_mat(
    ...
    // printf("dst_col[0]: %lf, dst_col[1]: %lf\n", tmp[0], tmp[1]);
    // exit(0);
}
...
static void ggml_compute_forward_get_rows(
    ...
    switch (src0->type) {
        ...
        case GGML_TYPE_Q5_1:
        case GGML_TYPE_Q8_0:
        case GGML_TYPE_Q8_0_H:
        case GGML_TYPE_Q8_0_S:
        case GGML_TYPE_Q8_0_F:
        case GGML_TYPE_Q8_0_M:
        case GGML_TYPE_Q4_0_F:
        case GGML_TYPE_Q4_0_H:
        case GGML_TYPE_Q4_0_S:        
        case GGML_TYPE_Q8_1:
        case GGML_TYPE_Q2_K:
        case GGML_TYPE_Q3_K:
        case GGML_TYPE_Q4_K:
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        //HMK
        case GGML_TYPE_Q4_0_F:  result = quantize_q4_0_f(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_0_H:  result = quantize_q4_0_h(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_0_S:  result = quantize_q4_0_s(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q4_1:    result = quantize_q4_1(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q5_0:    result = quantize_q5_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q5_1:    result = quantize_q5_1(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_0:    result = quantize_q8_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        //HMK
        case GGML_TYPE_Q8_0_H:  result = quantize_q8_0_h (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_0_S:  result = quantize_q8_0_s (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_0_F:  result = quantize_q8_0_f (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q8_0_M:  result = quantize_q8_0_m (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
