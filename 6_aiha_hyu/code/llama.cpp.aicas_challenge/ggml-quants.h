...
void quantize_row_q4_0_f_reference(const float * GGML_RESTRICT x, block_q4_0_f * GGML_RESTRICT y, int k);
void quantize_row_q4_0_h_reference(const float * GGML_RESTRICT x, block_q4_0_h * GGML_RESTRICT y, int k);
void quantize_row_q4_0_s_reference(const float * GGML_RESTRICT x, block_q4_0_s * GGML_RESTRICT y, int k);
...
void quantize_row_q8_0_h_reference(const float * GGML_RESTRICT x, block_q8_0_h * GGML_RESTRICT y, int k);
void quantize_row_q8_0_s_reference(const float * GGML_RESTRICT x, block_q8_0_s * GGML_RESTRICT y, int k);
void quantize_row_q8_0_f_reference(const float * GGML_RESTRICT x, block_q8_0_f * GGML_RESTRICT y, int k);
void quantize_row_q8_0_m_reference(const float * GGML_RESTRICT x, block_q8_0_m * GGML_RESTRICT y, int k);
...
void quantize_row_q4_0_f(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
void quantize_row_q4_0_h(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
void quantize_row_q4_0_s(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
...
void quantize_row_q8_0_h(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
void quantize_row_q8_0_s(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
void quantize_row_q8_0_f(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
void quantize_row_q8_0_m(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int k);
...
void dequantize_row_q4_0_f(const block_q4_0_f * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
void dequantize_row_q4_0_h(const block_q4_0_h * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
void dequantize_row_q4_0_s(const block_q4_0_s * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
...
void dequantize_row_q8_0_h(const block_q8_0_h * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
void dequantize_row_q8_0_s(const block_q8_0_s * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
void dequantize_row_q8_0_f(const block_q8_0_f * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
void dequantize_row_q8_0_m(const block_q8_0_m * GGML_RESTRICT x, float * GGML_RESTRICT y, int k);
...
void ggml_vec_dot_q4_0_f_q8_0_f(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q4_0_h_q8_0_h(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q4_0_s_q8_0_s(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q4_1_q8_1(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q5_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q5_1_q8_1(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q8_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q8_0_h_q8_0_h(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q8_0_s_q8_0_s(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q8_0_f_q8_0_f(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void ggml_vec_dot_q8_0_m_q8_0_m(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
...
size_t quantize_q4_0_f(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
size_t quantize_q4_0_h(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
size_t quantize_q4_0_s(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
...
size_t quantize_q8_0_h(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
size_t quantize_q8_0_s(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
size_t quantize_q8_0_f(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
size_t quantize_q8_0_m(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int nrows, int n_per_row, const float * imatrix);
